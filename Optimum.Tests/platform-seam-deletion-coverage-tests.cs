...
public class PlatformSeamDeletionCoverageTests
{
    ...
    [InlineData("Vintagestory.Client.NoObf/ChunkRenderer.cs", "game.Platform.BindSampler(8, 0);", "GL.BindSampler|(TextureParameterName)34049")]
    [InlineData("Vintagestory.Client.NoObf/ShaderRegistry.cs", "platform.SetSamplerLodBias(sampler, bias);|platform.SetTextureLodBias(atlases, bias);", "GL.SamplerParameter|(TextureParameterName)34049")]
